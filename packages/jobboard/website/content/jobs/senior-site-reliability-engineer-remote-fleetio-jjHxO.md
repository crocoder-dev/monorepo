...
companyName: "Fleetio"
url: "https://apply.workable.com/fleetio/j/03C18735DB/"
applyUrl: "https://apply.workable.com/fleetio/j/03C18735DB/apply/"
timestamp: 1616544000000
hashtags: "#rubylang,#rails,#operations,#marketing,#terraform,#docker,#aws,#heroku,#management,#git"
jobType: "software"
logoUrl: "https://jobboard-logos-bucket.s3.eu-central-1.amazonaws.com/fleetio"
companyWebsite: "http://www.fleetio.com/"
summary: "Fleetio wishes to hire a new senior site reliability engineer. If you have 5+ years experience with Ruby on Rails or similar web framework, consider applying."
summaryBackup: "Fleetio is looking for a senior site reliability engineer that has experience in: #rubylang, #rails, #operations."
featured: 20
---
...
Our Platform Engineering team is looking to add a Senior Software Engineer who has a knack for application performance and optimization. This role will have a direct impact on our customers, our engineers, and ultimately on our business by ensuring our application/services are highly available, performant, scalable, and secure.

This is a position we consider essential to the company’s success. _Be sure to mention coffee in your application so we know you actually read this. Please note, this is a remote role and is only open to US-based candidates._
