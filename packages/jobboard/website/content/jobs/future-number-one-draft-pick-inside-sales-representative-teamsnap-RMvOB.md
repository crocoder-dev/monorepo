---
title: "Future Number-One Draft Pick - Inside Sales Representative"
location: "Remote"
host: "https://jobs.lever.co/teamsnap?location=Remote"
companyName: "TeamSnap"
url: "https://jobs.lever.co/teamsnap/81fc2338-8d2e-489a-abf2-e7cd23cddca4"
applyUrl: "https://jobs.lever.co/teamsnap/81fc2338-8d2e-489a-abf2-e7cd23cddca4/apply"
timestamp: 1615161600000
hashtags: "#sales"
jobType: "other"
logoUrl: "https://jobboard-logos-bucket.s3.eu-central-1.amazonaws.com/teamsnap"
companyWebsite: "https://www.teamsnap.com/"
summary: "Interested in new opportunities and have our ERGs partner regularly with the executive team and people experience team to hold TeamSnap accountable in building an environment where everyone feels valued? TeamSnap has a job opening for a future number-one draft pick."
summaryBackup: "TeamSnap is looking for a future number-one draft pick that has experience in: #sales."
featured: 20
---
...
They say that timing is everything and that's also true for finding your dream job. We anticipate growing our outbound sales team and although we haven't quite opened up this role yet, sometimes a person comes along who's so dreamy that we end up creating this role sooner than later.

If you're a potential top recruit for the TeamSnap Inside Sales team, we want to meet you. Please submit your resumé and answer a few questions tied to your interest and experience in inside sales. While we can't promise that you'll hear back from us (we get a LOT of applications) we do promise that every submission will be read and considered by a real person, not an evil artificial intelligence robot.

We can't wait to hear from you!

**Location**

We are headquartered in Boulder, Colorado, but this role is remote (unless you happen to live near Boulder, in which case you’re welcome to come to the office). TeamSnap is a mostly-distributed company, so you must be very comfortable working with people who aren’t in the same physical location as you or each other. While we love all parts of the world, we can only hire permanent US residents at this time. 
...
\- 401K and [more](https://www.teamsnap.com/about/careers/teamsnap-employee-benefits-with-adp-totalsource.pdf)! 
