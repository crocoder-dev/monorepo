...
url: "https://apply.workable.com/atomicrobot/j/8D7456DA5F/"
applyUrl: "https://apply.workable.com/atomicrobot/j/8D7456DA5F/apply/"
timestamp: 1617148800000
hashtags: "#ios,#swift,#management,#spark,#ui/ux,#git,#socialmedia,#scrum,#office"
jobType: "software"
logoUrl: "https://jobboard-logos-bucket.s3.eu-central-1.amazonaws.com/atomic-robot"
companyWebsite: "https://atomicrobot.com/"
summary: "Atomic Robot wishes to hire a new senior ios developer. If you have experience with Agile development methodologies and practices, including automated testing tools and techniques, consider applying."
summaryBackup: "Love #ios, #swift, #management? Check out this job post!"
featured: 20
---
...
Welcome to the world of Atomic Robot, a mobile consulting agency home to a creative group of digital product specialists that have one thing in common: curiosity. We are seeking a Senior iOS Developer to join our community that’s keen to put their passion to work and expertly craft engaging mobile applications clients will love.
...
*   Collaborate with our talented team, partners, and clients to build effective and inspiring native mobile applications for iOS
*   Work with product managers, designers, and developers to deliver exceptional products with best-in-class user experience on time and within scope
*   Explore new techniques, trends, tools, and best practices and share your findings with our community to foster a culture of shared success and lifelong learning

## Requirements

Sound good? If you meet the following requirements, we’d love to chat:

*   Three-plus years’ experience developing apps for iOS
*   Extensive experience using Swift
*   Proven leadership skills and the ability to provide direction on projects
*   Familiarity with common software architecture patterns
*   Experience with Agile development methodologies and practices, including automated testing tools and techniques
*   Experience with Git
*   Excellent communication and client management skills
*   Self-motivated with a proactive attitude and innovative approach
*   Committed to product and service quality

**Bonus points:** A Bachelor’s in Computer Science or equivalent experience.
...
Hit the big button below to get the ball rolling.
