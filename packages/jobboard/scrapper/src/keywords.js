module.exports = {
  ...
  nodejs: {
    ...
    hashtag: "#nodejs",
    keywords: ["node", "nodejs", "node.js", "nodeJS"],
  },
  python: {
    rating: 80,
    class: {
  ...
  java: {
    ...
    hashtag: "#java",
    keywords: ["java", "javase", "javaee", "jvm", "javame", "jdk"],
  },
  csharp: {
    rating: 80,
    class: {
  ...
  cplusplus: {
    ...
    hashtag: "#cplusplus",
    keywords: ["c", "c++", "cplusplus", "cpp", "c/c++", "C++", "C"],
  },
  go: {
    rating: 80,
    class: {
  ...
  clojure: {
    ...
    hashtag: "#clojure",
    keywords: ["clojure", "cl", "clojurescript", "cljs"],
  },
  ruby: {
    rating: 80,
    class: {
  ...
  linux: {
    ...
    hashtag: "#linux",
    keywords: ["centos", "redhat", "ubuntu", "debian", "linux", "fedora"],
  },
  android: {
    rating: 40,
    class: {
  ...
  gcp: {
    ...
    hashtag: "#cloud",
    keywords: ["gcp", "googlecloud", "cloud"],
  },
  heroku: {
    rating: 40,
    class: {
  ...
  angular: {
    ...
    hashtag: "#angular",
    keywords: ["angular", "angular2", "angularjs"],
  },
  vue: {
    rating: 100,
    class: {
  ...
  unity: {
    ...
    hashtag: "#unity",
    keywords: ["unity", "unityengine", "unity3d"],
  },
  unreal: {
    rating: 60,
    class: {
  ...
  sqlserver: {
    ...
    hashtag: "#sqlserver",
    keywords: ["sqlserver", "sql server", "sql"],
  },
  dynamodb: {
    rating: 40,
    class: {
  ...
  french: {
    ...
    hashtag: "#French",
    keywords: ["french", "native speaking"],
  },
  greek: {
    rating: 10,
    class: {
    ...
    hashtag: "#Greek",
    keywords: ["greek", "native speaking"],
  },
  arabic: {
    rating: 10,
    class: {
    ...
    hashtag: "#Arabic",
    keywords: ["arabic", "native speaking"],
  },
  dutch: {
    rating: 10,
    class: {
  ...
  designer: {
    ...
    hashtag: "#ui/ux",
    keywords: ["designer", "designing", "ui", "ux", "ui/ux", "design"],
  },
  figma: {
    rating: 30,
    class: {
  ...
  italian: {
    ...
    hashtag: "#Italian",
    keywords: ["italian", "native speaking"],
  },
  spanish: {
    rating: 10,
    class: {
    ...
    hashtag: "#Spanish",
    keywords: ["spanish", "native speaking"],
  },
  sketch: {
    rating: 30,
    class: {
  ...
  productmanagement: {
    ...
    keywords: ["product management", "product"],
  },
  projectmanagement: {
    rating: 40,
    class: {
  ...
  accountant: {
    ...
    hashtag: "#accountant",
    keywords: ["accountant", "payroll", "accounting", "invoice"],
  },
  devops: {
    rating: 40,
    class: {
  ...
  webrtc: {
    ...
    hashtag: "#webrtc",
    keywords: ["webrtc", "WebRTC", "real-time communication"],
  },
  directx: {
    rating: 30,
    class: {
    ...
    hashtag: "#directX",
    keywords: ["directX", "direct2d", "direct3d", "directwrite"],
  },
  graphql: {
    rating: 20,
    class: {
  ...
  vulkan: {
    ...
    hashtag: "#vulkan",
    keywords: ["vulkan", "vulkan graphics", "vulkan API"],
  },
  mesa: {
    rating: 20,
    class: {
  ...
  crypto: {
    ...
    hashtag: "#crypto",
    keywords: ["crypto", "blockchain", "block chain"],
  },
  selenium: {
    rating: 40,
    class: {
