import blogHeader from "../../content/images/blogs/create-react-app-is-dead-what-are-the-alternatives.jpg?preset=responsive";
...
If you haven't used it before, you should definitely give it a try. Learn more about it in the [T3 Stack docs](https://t3.gg/docs/stack/introduction), and if you want to set up your monorepo by using t3 Stack project, take a look at [create-t3-turbo](https://github.com/t3-oss/create-t3-turbo).
