...
<ResponsiveImage src={DesignSystemOnMac} alt="An iMac displaying a design system on the screen" />
<br/>
<br/>
...
<ResponsiveImage src={StrugglingWithTheUi} alt="A man in a white t-shirt sitting in a booth while struggling with something on his laptop" />
<br/>
<br/>
...
<ResponsiveImage
  ...
  alt="A man in a blue plaid shirt doing some work organization by setting different sticky notes next to each other"
/>
<br/>
<br/>
