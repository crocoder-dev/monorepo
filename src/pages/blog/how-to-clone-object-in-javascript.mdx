import blogHeader from "../../content/images/blogs/how-to-clone-object-in-javascript.png";
...
- [Shallow Clone](#shallow-clone)
  ...
  - [Using Object.entries & Object.fromEntries](#using-object-entries---object-fromentries)
- [Deep Clone](#deep-clone)
  - [Using JSON.stringify & JSON.parse](#using-json-stringify---json-parse)
  - [\[Node.js ONLY\] Using v8.serialize & v8.deserialize](#node-js-only--using-v8-serialize---v8-deserialize)
- [External libraries](#using-external-libraries)
  - [Using $.extend()](#using---extend)
  - [Using \_.clone()](#using-_-clone)
  - [Using \_.cloneDeep()](#using-_-clonedeep)
