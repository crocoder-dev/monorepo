...
And after running our last command, 
...
This is especially true for programs that run as process ID 1 (PID) on Linux. These programs are treated differently than other processes.
