...
It should light up the mood a bit because this article isn't about JavaScript quirks. It's about the objectivly worst and most annoying features of the language.
...
`eval` is pure evil. I don't want to elaborate. Here is a non-so fictional story about it.
