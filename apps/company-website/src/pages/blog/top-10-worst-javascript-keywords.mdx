...
Back in 2007 we didn't knew better. We have used the tools that were availiable. As JavaScript developers we had a saying back in the time: *"At least we don't code in [Silverlight](https://en.wikipedia.org/wiki/Microsoft_Silverlight)."*
