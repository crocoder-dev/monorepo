...
export const meta = {
    ...
    description:
    "Are TypeScript enums useful? Typesafe? Do you even need to consider using them? Welcome to the TypeScript's typesafe wild west.",
    image: blogHeader,
    date: 1685008800000,
