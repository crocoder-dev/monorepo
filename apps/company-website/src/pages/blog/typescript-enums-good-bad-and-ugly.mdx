...
👉 Can be assigned either numeric or string values, and these values cannot be reassigned later in the code.
...
Enums (short for "enumerations") are a useful data structure in programming languages. TypeScript enums are a fine tool for creating a set of related constants or options. How useful are the TypeScript enums depends on the use case. They go really quickly from useful to bad to ugly.
