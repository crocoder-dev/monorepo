import blogHeader from "../../content/images/blogs/you-should-not-measure-developer-productivity-response-to-mckinsey.png?preset=responsive"
...
export const meta = {
    ...
    description: "Explore the contentious debate surrounding developer productivity measurement ignited by McKinsey's recent article. Discover why focusing on individual metrics may hinder, not help, software engineering teams, and learn how to adopt a more comprehensive, evidence-driven approach to enhance teamwork and performance.",
    image: blogHeader,
    date: 1694163045000,
