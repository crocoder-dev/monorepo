...
export const meta = {
  ...
  description: "Do holiday feature freezes reduce risk or hinder teams? Explore Sentry’s data on freeze-induced bottlenecks and discover strategies to maintain stability without slowing development.",
...
All the following examples and charts are based on data from the Sentry repository ([getsentry/sentry](https://github.com/getsentry/sentry)). The data includes only pull requests (PRs) created by Sentry employees, with all auto-generated and bot PRs filtered out.
...
<iframe 
    src="https://metrics.dxta.dev/getsentry/sentry?chart=MRsOpened&team=1&width=1100&height=360&lines=value&theme=light&dashboard=delivery" 
    width="1100" 
    height="360" 
    style={{border: "none"}}>
</iframe>
...
<iframe 
    src="https://metrics.dxta.dev/getsentry/sentry?chart=CycleTime&team=1&width=1100&height=360&lines=median&theme=light&dashboard=delivery" 
    width="1100" 
    height="360" 
    style={{border: "none"}}>
</iframe>
...
Digging deeper into the data, my team have found that about half of the PRs from Weeks 51 (Dec 16 - Dec 22) and 52 (Dec 23 - Dec 29) didn’t get deployed until Weeks 03 (Jan 13 - Jan 19) or 04 (Jan 20 - Jan 26), and some are still stuck. That’s a long time for code to sit idle, which means more merge conflicts, rework, and potential bugs creeping in.
...
<iframe 
    src="https://metrics.dxta.dev/getsentry/sentry?chart=DeployFreq&team=1&width=1100&height=360&lines=value&theme=light&dashboard=delivery" 
    width="1100" 
    height="360" 
    style={{border: "none"}}>
</iframe>
...
By Week 04 (Jan 20 - Jan 26), deployments fall again, not because work has slowed down, but because most of the queued-up PRs have already been merged and deployed. Now, the team is dealing with the aftermath; stabilizing, fixing issues, and getting back to a normal cadence.
...
<iframe 
    src="https://metrics.dxta.dev/getsentry/sentry?chart=MRsWoReview&team=1&width=1100&height=360&lines=value&theme=light&dashboard=delivery" 
    width="1100" 
    height="360" 
    style={{border: "none"}}>
</iframe>
...
Big pauses in deployment force teams into bad trade-offs. Keeping deployments small and regular helps avoid these last-minute scrambles.
