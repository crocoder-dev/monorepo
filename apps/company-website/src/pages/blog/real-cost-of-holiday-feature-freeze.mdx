...
All the following examples and charts are based on data from the Sentry repository ([getsentry/sentry](https://github.com/getsentry/sentry)). The data includes only pull requests (PRs) created by Sentry employees, with all auto-generated and bot PRs filtered out. If you want to check out the metrics used and explore more, head over to [Holoday Feature Freeze](https://metrics.dxta.dev/getsentry/sentry/sentry-feature-freeze) dashboard.
...
<iframe 
    src="https://metrics.dxta.dev/getsentry/sentry?chart=MRsOpened&team=1&width=1100&height=360&lines=value&theme=light&dashboard=sentry-feature-freeze" 
    width="1100" 
    height="360" 
    style={{border: "none"}}>
</iframe>
...
<iframe 
    src="https://metrics.dxta.dev/getsentry/sentry?chart=CycleTime&team=1&width=1100&height=360&lines=median&theme=light&dashboard=sentry-feature-freeze" 
    width="1100" 
    height="360" 
    style={{border: "none"}}>
</iframe>
