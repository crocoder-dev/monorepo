...
# By configuring the GIN_MODE environment variable, we determine whether our application will run in release or debug mode.
...
# Cache mounts speed up installation of existing dependencies, empowering our image to sail smoothly through vast dependency seas.
...
# Setup air and delve, via go install enhances development with hot reload capabilities and powerful debugging prowess
