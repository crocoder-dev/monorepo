...
The architecture is a classic web service model that leverages several services and design principles for scalable, secure, and maintainable web applications. Uses Cloudfront as CDN to cache your SPA's static files (js, css, html) and deploy your compiled binaries or Docker container on the EC2 behind an API Gateway.
