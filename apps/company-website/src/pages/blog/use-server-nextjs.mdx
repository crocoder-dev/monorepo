import blogHeader from "../../content/images/blogs/use-server-nextjs.png?preset=responsive";
...
export const meta = {
  ...
  description:
    "Curious about \"use server\" in Next.js 13.4 and 14? Discover how Server Actions can streamline server-side processes, reduce client-side JavaScript, and supercharge form functionalities.",
